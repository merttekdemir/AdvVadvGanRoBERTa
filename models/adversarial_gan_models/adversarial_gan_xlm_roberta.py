...
from models.backbones.adversarial_xlm_roberta import AdversarialXLMRobertaModel
from models.discriminator import Discriminator
from models.generator import Generator


class AdvGanXLMRobertaModel(pl.LightningModule):
    def __init__(
        self,
        pretrained_model_path: str = "castorini/afriberta_large",
        num_labels: int = 2,
        ...
        self.model = AdversarialXLMRobertaModel.from_pretrained(
